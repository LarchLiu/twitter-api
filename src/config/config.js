...
const envVarsSchema = Joi.object()
  .keys({
    ...
    GITHUB_CLIENT_SRCRET: Joi.string().description('github client secret'),
    GITHUB_CALLBACK_URL: Joi.string().description('github callback url'),
  })
  .unknown();
...
module.exports = {
  ...
  github: {
    ...
    clientSecret: envVars.GITHUB_CLIENT_SRCRET,
